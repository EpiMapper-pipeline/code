...
Uses [Picard](https://broadinstitute.github.io/picard/) to remove duplicated reads mapped to the same place in of a reference genome during alignment, and visulizing results.
